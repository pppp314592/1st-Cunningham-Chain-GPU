...
4. **実績:** 10〜10^20 の全範囲 (1000バッチ) を GPU で32.8時間でスキャン完了。CC15は `90616211958465842219` 1件のみと確定
...
| CC15 | 90616211958465842219 | 全15項素数確認済み ✅ |
| CC15 (10〜10^20 全数探索) | 上記1件のみ | 32.8時間/744バッチで完了 ✅ |
